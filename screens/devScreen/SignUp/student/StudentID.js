...
export default function S_SignUp_StudentID({ navigation }) {
  ...
  const handleNextScreen = () => {
    ...
    if (_grade === null) {
      ...
      return navigation.navigate('SignUp_AuthenticationMethod', { email: email, accountID: accountID, password: password, phoneNumber: phoneNumber, _grade: _grade, _class: _class, _number: _number, firstName: firstName, lastName: lastName, })
    }
  }
